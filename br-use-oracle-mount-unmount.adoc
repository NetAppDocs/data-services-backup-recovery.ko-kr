...
[role="lead"]
복구 작업을 위해 제어된 상태로 데이터베이스에 액세스해야 할 때 Oracle Database 복구 지점을 마운트합니다. 자동 카탈로그 생성이 비활성화된 경우 RMAN 복구 카탈로그에서 복구 지점 메타데이터를 수동으로 카탈로그화할 수 있습니다.
