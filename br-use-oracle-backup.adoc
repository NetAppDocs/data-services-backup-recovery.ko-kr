...
summary: NetApp 백업 및 복구를 통해 Oracle 데이터베이스 워크로드를 보호하십시오. 
---
...
* 리소스 집합에 대한 백업 및 복원 작업을 관리하기 위해 보호 그룹을 생성합니다. 자세한 내용은 link:br-use-kvm-protection-groups.html["NetApp Backup and Recovery를 사용하여 Oracle Database 워크로드용 보호 그룹을 생성하고 관리하세요"]를 참조하십시오.
