...
---
= NetApp Backup and Recovery를 사용한 VMware 보호 워크플로
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
[role="lead"]
NetApp Backup and Recovery를 사용하여 VMware VM과 데이터스토어를 보호하세요. NetApp Backup and Recovery는 빠르고 공간 효율적이며, 크래시 일관성 및 VM 일관성을 보장하는 백업 및 복원 작업을 제공합니다. 지원되는 백업 대상으로 VMware 워크로드를 백업하고 온프레미스 VMware 호스트로 VMware 워크로드를 복원할 수 있습니다.
