...
** ASP.NET Core Runtime 8.0.12 호스팅 번들(및 모든 후속 8.0.x 패치)
** PowerShell 7.4.2 이상
** 호스트 가디언 서비스 역할이 설치되어 있는지 확인하십시오(참조 https://learn.microsoft.com/en-us/windows-server/administration/server-manager/add-remove-roles-features?tabs=gui#add-roles-and-features-to-windows-server["Microsoft Windows Server 설명서"^] (지침을 위해)
