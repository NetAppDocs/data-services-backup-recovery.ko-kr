...
---
= NetApp Backup and Recovery를 사용하여 Kubernetes 워크로드를 관리하는 방법에 대해 알아보십시오.
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
[role="lead"]
NetApp Backup and Recovery에서 Kubernetes 워크로드를 관리하면 Kubernetes 클러스터와 애플리케이션을 한 곳에서 검색, 관리 및 보호할 수 있습니다. Kubernetes 클러스터에서 호스팅되는 리소스와 애플리케이션을 관리할 수 있습니다. 또한 단일 인터페이스를 사용하여 Kubernetes 애플리케이션에 보호 정책을 생성하고 연결할 수도 있습니다.
