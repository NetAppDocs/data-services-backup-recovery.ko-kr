...
* 리소스 집합에 대한 백업 및 복원 작업을 관리하기 위해 보호 그룹을 생성합니다. 자세한 내용은 link:br-use-hyperv-protection-groups.html["NetApp Backup and Recovery에서 Hyper-V 보호 그룹 생성 및 관리"]을 참조하십시오.
