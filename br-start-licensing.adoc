...
* NetApp Console을 사용하여 Backup and Recovery를 사용하는 경우, 사용량 기반 요금제(PAYGO) 라이선스를 구독하거나 자체 라이선스 구매(BYOL) 라이선스를 구입할 수 있습니다.
...
NetApp Backup and Recovery에 대한 라이선스를 설정하십시오.
...
=== 마켓플레이스 또는 BYOL 라이선스를 통한 연간 계약 사용
...
== NetApp Backup and Recovery 로컬 배포를 위한 라이선스 설정

NetApp Console의 온프레미스 버전에 대한 라이선스를 설정합니다.
...
NetApp Console 로컬 배포를 사용하여 BYOL 라이선스를 관리할 수 있습니다. 콘솔에서 새 라이선스를 추가하고, 기존 라이선스를 업데이트하고, 라이선스 상태를 확인할 수 있습니다.
