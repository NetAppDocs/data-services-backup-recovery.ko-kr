...
summary: NetApp Backup and Recovery에서 KVM 워크로드에 대한 보호 그룹을 만들고 관리합니다. 
---
= NetApp Backup and Recovery를 사용하여 KVM 워크로드에 대한 보호 그룹을 만들고 관리합니다.
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
* 보호 그룹을 만듭니다.
* 보호 세부 정보를 확인하세요.
* 지금 보호 그룹을 백업하세요. 보다 link:br-use-kvm-backup.html["지금 KVM 워크로드를 백업하세요"] .
* 보호 그룹을 삭제합니다.
