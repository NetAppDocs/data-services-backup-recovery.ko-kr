...
... Hyper-V 호스트를 새로 추가하려면 호스트의 FQDN 또는 IP 주소를 입력하고 콘솔 에이전트와 자격 증명을 선택하십시오. 콘솔 에이전트에서 FQDN을 확인할 수 없는 경우 대신 IP 주소를 사용하십시오. 장애 조치 클러스터의 경우 클러스터 관리 IP 주소를 입력하십시오.


.. *고급 설정*: 선택적으로 NetApp Hyper-V 플러그인의 설치 경로를 입력할 수 있습니다.
