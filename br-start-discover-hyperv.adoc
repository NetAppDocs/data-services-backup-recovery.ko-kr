...
.. *호스트 등록*: 호스트의 FQDN 또는 IP 주소, 자격 증명, 콘솔 에이전트 및 포트 번호를 입력하여 새 Hyper-V 호스트를 추가합니다. 콘솔 에이전트에서 FQDN을 확인할 수 없는 경우 대신 IP 주소를 사용하세요. FCI 클러스터의 경우 FCI 클러스터 관리 IP 주소를 입력하세요.
