...
---
= NetApp Backup and Recovery의 보호 여정 계획 옵션
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
이러한 기준 외에도 클라우드 스토리지는 *Datalock and Ransomware protection* 기능을 사용하면 추가적인 보안 옵션을 제공하며, 오래된 백업 파일을 보관용 스토리지 클래스로 선택하면 추가적인 비용 절감 효과를 얻을 수 있습니다. link:prev-ontap-policy-object-options.html["DataLock 및 랜섬웨어 보호와 보관 스토리지 설정에 대해 자세히 알아보세요."].
